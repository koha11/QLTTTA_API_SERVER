...
class ClassController {
  index(req, res, next) {
    excStmt('select * from class').then((value) => {
      console.log(value);
  ...
  show(req, res, next) {
    ...
    excStmt(`select * from class where class_id = '${id}'`).then((value) => {
  ...
  update(req, res, next) {
    ...
    excStmt(
      `update class set ${updateObj.set} where ${updateObj.id}`,
      'post'
    ).then((value) => {
      res.send('done');
    });
  ...
  create(req, res, next) {
    ...
    excStmt(
      `insert into class(${insertObj.key}) values(${insertObj.value})`,
      'post'
    ).then((value) => {
      res.send('done');
    });
  ...
  delete(req, res, next) {
    ...
    excStmt(`delete from class where ${condition}`, 'post').then((value) => {
      console.log(value);
      res.send(`done`);
    });
  }
